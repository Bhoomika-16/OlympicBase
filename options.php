...
<html lang="en">
    ...
    <body class="Sports">
        <header>
        <section id="courses">
            <h1 class="display-4 coursehead text-center Sphdr">Select an operation</h1> <br>
            <div class="container-fluid cards text-lg-center ">
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="card text-center">
                            <img src="./images/insert1.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
                                <h5 class="card-title Mcn">Insert a new record</h5>
                                <a href="./iform.php" add target="_blank" class="stretched-link" style="text-decoration: none;" rel="Click here"></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="card text-center">
                            <img src="./images/delete1.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
                                <h5 class="card-title Mcn">Delete existing record</h5>
                                <a href="./dform.php" add target="_blank" class="stretched-link" style="text-decoration: none;" rel="Click here"></a>
                            </div>
                        </div>
                    </div>
                </div>
