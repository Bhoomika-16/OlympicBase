    ...
    <div class="container"> 
        <div class="row">
          <div class="text-center">
            <h2 class="site-title desc" style="font-size:30px;">Sydney 2000</h2>
          </div>
        </div>
    </div>
<table>
...
<a href="https://olympics.com/en/olympic-games/sydney-2000" add target="_blank">https://olympics.com/en/olympic-games/sydney-2000</a><br>
    ...
    <p class="cp"> Built by Bhoomika.B.Poojari & Gagana <br>Disclaimer:This website consists of results of only selected games and it's events.</p>
  </footer>
  <!-- /footer  -->
