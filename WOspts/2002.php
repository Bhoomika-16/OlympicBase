    ...
    <div class="container"> 
        <div class="row">
          <div class="text-center">
            <h2 class="site-title desc" style="font-size:30px;">Salt Lake City 2002</h2>
          </div>
        </div>
    </div>
<table>
  ...
  <?php
      ...
      $sql="SELECT * FROM winter_olympic";
      $result=$conn->query($sql);
      if($result->num_rows>0){
        while($row=$result->fetch_assoc()){
          if($row["Year"]==2002)
          echo "<tr><td>".$row["Sportid"]."</td><td>".$row["Woid"]."</td><td>".$row["Gold"]."</td><td>".$row["Silver"]."</td><td>".$row["Bronze"]."</td></tr>";
        }
      }
        else{
          echo "no results";
...
<a href="https://olympics.com/en/olympic-games/salt-lake-city-2002" add target="_blank">https://olympics.com/en/olympic-games/salt-lake-city-2002</a><br>
