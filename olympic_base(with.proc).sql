...
-- Procedures
--
DROP PROCEDURE IF EXISTS `COUNT_ATHLETES`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `COUNT_ATHLETES` ()  SELECT COUNT(*) AS Total FROM athletes$$
...
(2028, 'Summer', 'Los Angeles', 'USA', 0, '2028-07-21');
