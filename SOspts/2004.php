    ...
    <div class="container"> 
        <div class="row">
          <div class="text-center">
            <h2 class="site-title desc" style="font-size:30px;">Athens 2004</h2>
          </div>
        </div>
    </div>
<table>
...
<footer id="footer" class="text-center hdrbg">
    <a href="https://olympics.com/en/olympic-games/athens-2004" add target="_blank">https://olympics.com/en/olympic-games/athens-2004</a><br>
