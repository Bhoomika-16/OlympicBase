...
<h2>Deleting Existing Results</h2>
...
<?php
      ...
      if($Games=="Summer"){
        $sql1="DELETE FROM `summer_olympic` WHERE Year=$Year and Sportid=$Sportid;";
        if(mysqli_query($db, $sql1))
        echo "Deleted!";
      }
      else{
      $sql2="DELETE FROM `winter_olympic` WHERE Year=$Year and Sportid=$Sportid;";
      if(mysqli_query($db, $sql2))
      echo "Deleted!";
      }
    }
?>
<br><a href="./login.php" class="px-2">LOGOUT</a>
</body>
 <!-- footer -->
